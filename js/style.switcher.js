...
var styleSwitcher = {
	...
	initialize: function() {
		...
		// Style Switcher CSS
		$("head").append($('<link rel="stylesheet">').attr("href", "style-switcher.css"/*tpa=http://www.crivos.com/themes/porto/master/style-switcher/master/style-switcher/style-switcher.css*/) );
		$("head").append($('<link rel="stylesheet/less">').attr("href", "http://www.crivos.com/themes/porto/master/style-switcher/master/less/skin.less") );
		$("head").append($('<link rel="stylesheet">').attr("href", "colorpicker.css"/*tpa=http://www.crivos.com/themes/porto/master/style-switcher/master/style-switcher/colorpicker/css/colorpicker.css*/) );

		$.getScript("bootstrap-colorpicker.js"/*tpa=http://www.crivos.com/themes/porto/master/style-switcher/master/style-switcher/colorpicker/js/bootstrap-colorpicker.js*/, function(data, textStatus, jqxhr) {

			less = {
				env: "development"
			};

			$.getScript("less.js"/*tpa=http://www.crivos.com/themes/porto/master/style-switcher/master/less/less.js*/, function(data, textStatus, jqxhr) {
		...
		$.getScript("cssbeautify.js"/*tpa=http://www.crivos.com/themes/porto/master/style-switcher/master/style-switcher/cssbeautify/cssbeautify.js*/, function(data, textStatus, jqxhr) {});
	...
	setColor: function(color) {
		...
		if(color == this.container.find("ul[data-type=colors] li:first a").attr("data-color-hex")) {
			$("h1.logo img").attr("src", "logo-default.png"/*tpa=http://www.crivos.com/themes/porto/master/style-switcher/img/logo-default.png*/);
		} else {
			$("h1.logo img").attr("src", "logo-1.png"/*tpa=http://www.crivos.com/themes/porto/master/style-switcher/img/logo.png*/);
		}
	...
	setLayoutStyle: function(style, refresh) {
		...
		if(style == "wide") {
			...
			$("link[href*='bootstrap-responsive']").attr("href", "bootstrap-responsive-1.css"/*tpa=http://www.crivos.com/themes/porto/master/style-switcher/css/bootstrap-responsive.css*/);
			...
			$("body").addClass("boxed");
			$("link[href*='bootstrap-responsive']").attr("href", "bootstrap-responsive-boxed.css"/*tpa=http://www.crivos.com/themes/porto/master/style-switcher/css/bootstrap-responsive-boxed.css*/);
