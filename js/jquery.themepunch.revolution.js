									...
									container.find('.tp-caption iframe').each(function() {
										try {
												if ($(this).attr('src').indexOf('you')>0) {
													...
													s.src = "player_api.js"/*tpa=http://www.youtube.com/player_api*/; /* Load Player API*/
									 ...
									 container.find('.tp-caption iframe').each(function() {
										try{
												if ($(this).attr('src').indexOf('vim')>0) {
													...
													f.src = "froogaloop2.min.js"/*tpa=http://a.vimeocdn.com/js/froogaloop2.min.js*/; /* Load Player API*/
													var before = document.getElementsByTagName("script")[0];
